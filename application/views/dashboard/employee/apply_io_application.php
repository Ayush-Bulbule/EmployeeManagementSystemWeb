...
<body>
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" action="Home/ApplyIoApplication/add_io_application" class="register-form" id="register-form">
 ...
 />
                    ...
                    <textarea type="text" class="form-input form-control textarea <?php echo (form_error('description') !=  "") ? 'is-invalid' : '' ?>" name="description" id="description" placeholder="Description"></textarea>
...
<div class="form-group">
    ...
    <input type="file" name="application" id="application" value="<?php echo set_value('application'); ?>"
        class="form-input form-control <?php echo (form_error('application') !=  "") ? 'is-invalid' : '' ?>"
        placeholder="">
    <p class="invalid-feedback "><?php echo strip_tags(form_error('application')); ?></p>
