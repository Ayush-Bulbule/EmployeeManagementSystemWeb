...
<select class="form-select <?php echo (form_error('application_type') != "") ? 'is-invalid' : '' ?>" name="application_type" id="application_type" style="width: 250px; margin-bottom: 20px">
...
<div class="form-group">
    <input type="submit" name="signin" id="signin" class="btn btn-primary ml-5" value="Search"
         />
...
<form action="<?php echo base_url() . 'Registrar/IoApplication/generate_pdf' ?>" name="mainForm"
    id="mainForm signupform" class="signupform" method="post">
    <div class="form-row  d-flex align-items-center ms-auto align-item-space-between">
        <!-- Select Training Status -->
        <div class="row">
...
<div class="form-group">
    <input type="submit" name="signin" id="signin" class="btn btn-primary ml-5" value="Generate PDF"
         />
