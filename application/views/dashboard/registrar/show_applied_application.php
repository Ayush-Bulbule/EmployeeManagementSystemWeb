            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url() . 'Registrar/IoApplication/accept_io_application/' . $application['id'].  "/null" ?>"
                                style="font-size: 12px; border-radius: 5px" class="btn btn-primary"> Accept
                            </a>
                        </td>
                        <td>
                            <a href="<?php echo base_url() . 'Registrar/IoApplication/decline_io_application/' . $application['id'] ."/null" ?>"
