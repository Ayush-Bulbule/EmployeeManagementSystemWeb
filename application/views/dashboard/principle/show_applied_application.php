            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url() . 'Principle/IoApplication/accept_io_application/' . $application['id'].  "/dummy remark" ?>"
                                style="font-size: 12px; border-radius: 5px" class="btn btn-primary"> Accept
                            </a>
                        </td>
                        <td>
                            <a href="<?php echo base_url() . 'Principle/IoApplication/decline_io_application/' . $application['id'] ."/dummy remark" ?>"
