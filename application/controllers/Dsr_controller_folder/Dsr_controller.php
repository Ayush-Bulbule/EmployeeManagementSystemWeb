...
class Dsr_controller extends CI_Controller {
	...
	public function notification()
	{
		...
		{
			/*$this->load->view('dsr/notification');
			//$srNo = $_GET['sr_no'];
			$sr=$this->input->get('sr');
  			$response=$this->Dsr__model->delete($sr);
  			if($response==true)
			  {
    			//echo "Data deleted successfully !";
				redirect(base_url().'index.php/Dsr_controller_folder/Dsr_controller/notification');
	        ...
	        $this->Dsr_Model->deleterecords($sr);
	        redirect(base_url().'index.php/Dsr_controller_folder/Dsr_controller/notification');
